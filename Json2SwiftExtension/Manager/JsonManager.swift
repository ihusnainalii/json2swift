...
//  Json2Swift
//
//  Created by Husnain Ali on 25/02/22.
//
...
class JsonManager {
    ...
    func saveRootClassName(_ name: String) {
        ...
        let dir = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true)[0]
        let documents = dir.replacingOccurrences(of: "/Documents", with: "/Library/Containers/com.generate.json.Json2Swift/Data/Documents")
